...
class Songs(var songID :Long, var songTitle:String, var artist:String, var album:String, var songData: String, var dateAdded:Long, var songAlbum:Long?, var duration: Int  ) : Parcelable{
